...
// ===========================================================================================
var data = undefined;
var gesundheitData = undefined;
var preppingData = undefined;
if (typeof http_data === "undefined") {
    // We're developing locally, initialize sample data.
    isDevelopmentEnvironment = true;
    var data =
        {"range":"Retine!A24:G101","majorDimension":"ROWS","values":[
        ["08:43","Ochtend","nvt","00:16:06","Ja","","Zorgen dat ik om 8:30 weg ben, tijd = 8:30 - duratie van routine."],
        ["","","Tanden poetsen","00:02:00"],["","","Deo opdoen"],["","","Parfum opdoen"],["","","Gesundheit: 1","00:10:00"],["","","Pet opdoen","00:02:00"],["","","Mobiel, beurs, sleutels"],
        ["","","Prep: Middag"],["","","Prep: Fitness"],[],[],[],[],[],[],[],[],["23:33","Avond","nvt","00:06:54","Ja","","Zorgen dat ik om 23:30 ga slapen, tijd = 23:30 - duratie van routine."],["","","Kamer opruimen","00:02:00"],["","","Deur op slot doen & sleutel afhalen"],["","","Thermostaat lager zetten"],["","","Monitors uitzetten (lampjes)"],["","","Ragen","00:01:00"],["","","Tanden poetsen","00:02:00"],["","","Wekker(s) zetten","00:01:00"],["","","Gezichtscreme opdoen"],["","","Prep: Fitness"]]
        };
...
data.values.forEach(function(row) {
    if (row[0]) {
        ...
        if (actionName.startsWith(totalMealKeywordPrefix)) {
        ...
        } else if (actionName.startsWith(totalPrepListKeywordPrefix)) {
            ...
            if (prepList) {
                ...
                currentRoutine.actions.push(new Action(actionName));
            }
        } else {
