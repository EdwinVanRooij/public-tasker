  ...
  var data = {
    ...
    values: [
      [
        ...
        "Ja",
        "",
        "Zorgen dat ik om 8:30 weg ben, tijd = 8:30 - duratie van routine.",
      ],
      ["", "", "Tanden poetsen", "00:02:00"],
      ["", "", "Deo opdoen"],
      ["", "", "Parfum opdoen"],
      ["", "", "Gesundheit: 1", "00:10:00"],
      ["", "", "Pet opdoen", "00:02:00"],
      ["", "", "Mobiel, beurs, sleutels"],
      ["", "", "Prep: Middag"],
      ["", "", "Prep: Fitness"],
      [],
      [],
      ...
      [
        ...
        "Ja",
        "",
        "Zorgen dat ik om 23:30 ga slapen, tijd = 23:30 - duratie van routine.",
      ],
      ["", "", "Kamer opruimen", "00:02:00"],
      [
        "",
        "",
        "Deur op slot doen & sleutel afhalen en nog een ding waardoor het lang wordt",
      ],
      ["", "", "Thermostaat lager zetten"],
      ["", "", "Monitors uitzetten (lampjes)"],
      ["", "", "Ragen", "00:01:00"],
      ["", "", "Tanden poetsen", "00:02:00"],
      ["", "", "Wekker(s) zetten", "00:01:00"],
      ["", "", "Gezichtscreme opdoen"],
      ["", "", "Prep: Fitness"],
    ],
  };
      ...
      if (prepList) {
        prepList.items.forEach((item) => {
          ...
          currentRoutine.actions.push(
            new Action(prepListItemToActionString(item))
          );
        });
      } else {
...
for (var i = 0; i < routines.length; i++) {
  ...
  var currentRoutineNameAsKey = currentRoutine.name
    .replace(/\s+/g, "_")
    .toUpperCase();
