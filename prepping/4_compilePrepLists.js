...
compiledPrepList.items.sort(function(itemA, itemB){
    if (typeof itemA === 'string' || itemA instanceof String || typeof itemB === 'string' || itemB instanceof String) {
        // Ignore simple strings, we only sort items.
        return -1;
    }
